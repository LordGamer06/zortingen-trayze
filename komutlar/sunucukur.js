...
exports.run = async(client, message, params) => {
 ...
 const filter = m => m.author.id === message.author.id;
    ...
    message.author.send(`${message.author}, Merhaba! ben ${client.user.username}.*${message.guild.name}* adlı sunucuyu şuan kuruyorum. ben kurarken destek sunucumuza gelmeyi unutma https://discord.gg/AKbAEfEAam !`)
